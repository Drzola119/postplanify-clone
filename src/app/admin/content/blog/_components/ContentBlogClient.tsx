    ...
    return (
      <div className="bg-white rounded-2xl border border-gray-200 shadow-xs p-6 max-w-2xl">
        ...
        <form onSubmit={handleSave} className="space-y-4 text-xs">
          ...
          <div>
            <label className="font-bold text-gray-700">Excerpt</label>
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-end">
        <button onClick={openNew} className="flex items-center gap-2 px-4 py-2 bg-[#01696f] text-white text-xs font-bold rounded-xl shadow-xs hover:bg-[#015257]">New Blog Override</button>
      </div>
