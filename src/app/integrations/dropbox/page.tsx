...
export const metadata: Metadata = {
  title: "Dropbox Integration — Schedule Posts with PostPlanify",
  description:
    "Connect Dropbox to PostPlanify to import images and videos from your Dropbox and schedule them across Instagram, TikTok, X, LinkedIn, and more.",
  alternates: { canonical: "/integrations/dropbox" },
};
...
const GETTING_STARTED_STEPS = [
  ...
  "Click the Dropbox button in the media picker.",
  "Sign in to Dropbox if prompted.",
  "Choose the files you want.",
  "They're added to your post.",
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-7">
                <div className="flex h-24 w-24 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-white shadow-sm">
                  <Image
                    src="/images/integrations/dropbox-logo.svg"
                    alt="Dropbox"
                    width={64}
                    height={64}
                    className="h-16 w-16"
                ...
                <div>
                  <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">Dropbox</h1>
                  <p className="mt-2 text-lg text-blue-100">
                    Import images and videos from Dropbox into your posts.
                  </p>
          ...
          <div className="grid gap-10 lg:grid-cols-[200px_minmax(0,1fr)]">
            ...
            <div>
              <h2 className="text-2xl font-bold leading-8 text-gray-900">
                Dropbox integration for PostPlanify
              </h2>
              <p className="mt-4 text-base leading-relaxed text-gray-600">
                Pull images and videos from your Dropbox into the PostPlanify composer — no downloading and re-uploading. Pick a file through the Dropbox picker and schedule it across every platform.
              </p>
              ...
              <p className="mt-2 text-base leading-relaxed text-gray-600">
                You&apos;ll need a Dropbox account. Files are chosen through the Dropbox picker.
              </p>
            ...
            <div className="flex flex-col gap-10 p-6 sm:p-8 lg:flex-row lg:items-center lg:gap-8 lg:p-10">
              <div className="flex-1 lg:max-w-[44%]">
                ...
                <h3 className="text-2xl font-bold leading-tight tracking-tight text-white sm:text-3xl">
                  Schedule from Dropbox in minutes
                </h3>
