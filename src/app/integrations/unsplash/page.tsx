...
export const metadata: Metadata = {
  title: "Unsplash Integration — Free Stock Photos in PostPlanify",
  description:
    "Search free Unsplash stock photos inside PostPlanify and add them to your posts in one click, then schedule across Instagram, TikTok, X, LinkedIn, and more.",
  alternates: { canonical: "/integrations/unsplash" },
};
...
const GETTING_STARTED_STEPS = [
  ...
  "Click the Unsplash button in the media picker.",
  "Search for a photo by keyword.",
  "Pick the image you want.",
  "It's added to your post with attribution.",
  "Schedule it across your platforms.",
];
        ...
        <section className="bg-blue-800">
          <Container className="py-8 sm:py-10">
            <nav className="mb-6 text-sm text-blue-200">
              ...
              <span className="text-white">Unsplash</span>
            </nav>
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-7">
                <div className="flex h-24 w-24 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-white shadow-sm">
                  <Image
                    src="/images/integrations/unsplash-logo.svg"
                    alt="Unsplash"
                    width={64}
                    height={64}
                    className="h-16 w-16"
                ...
                <div>
                  <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">Unsplash</h1>
                  <p className="mt-2 text-lg text-blue-100">
                    Add free Unsplash stock photos to your posts.
                  </p>
          ...
          <div className="grid gap-10 lg:grid-cols-[200px_minmax(0,1fr)]">
            ...
            <div>
              <h2 className="text-2xl font-bold leading-8 text-gray-900">
                Unsplash integration for PostPlanify
              </h2>
              <p className="mt-4 text-base leading-relaxed text-gray-600">
                Search millions of free, high-quality Unsplash photos right inside PostPlanify and add them to your posts in one click — with photographer attribution handled automatically.
              </p>
              ...
              <p className="mt-2 text-base leading-relaxed text-gray-600">
                No account or setup needed — Unsplash photos are free to use, with attribution added for you.
              </p>
            ...
            <div className="flex flex-col gap-10 p-6 sm:p-8 lg:flex-row lg:items-center lg:gap-8 lg:p-10">
              <div className="flex-1 lg:max-w-[44%]">
                ...
                <h3 className="text-2xl font-bold leading-tight tracking-tight text-white sm:text-3xl">
                  Schedule from Unsplash in minutes
                </h3>
