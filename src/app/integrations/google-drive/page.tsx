...
export const metadata: Metadata = {
  title: "Google Drive Integration — Schedule Posts with PostPlanify",
  description:
    "Connect Google Drive to PostPlanify and attach your photos and videos straight from Drive — no downloading first. Pick a file, drop it into your post, and schedule it across every platform.",
  alternates: { canonical: "/integrations/google-drive" },
};
...
const GETTING_STARTED_STEPS = [
  ...
  "Click the Google Drive button in the media picker.",
  "Sign in to Google and authorize access.",
  "Browse your Drive files and folders.",
  "Select an image or video to add to your post.",
          ...
          <Container className="py-8 sm:py-10">
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-7">
                ...
                <div>
                  <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">Google Drive</h1>
                  <p className="mt-2 text-lg text-blue-100">
                    Pull images and files from Google Drive into your posts.
                  </p>
          ...
          <div className="grid gap-10 lg:grid-cols-[200px_minmax(0,1fr)]">
            ...
            <div>
              <h2 className="text-2xl font-bold leading-8 text-gray-900">
                Google Drive integration for PostPlanify
              </h2>
              ...
              <p className="mt-2 text-base leading-relaxed text-gray-600">
                You&apos;ll need a Google account with Drive. The first time you use the integration, you authorize the connection once.
              </p>
            ...
            <div className="flex flex-col gap-10 p-6 sm:p-8 lg:flex-row lg:items-center lg:gap-8 lg:p-10">
              <div className="flex-1 lg:max-w-[44%]">
                ...
                <h3 className="text-2xl font-bold leading-tight tracking-tight text-white sm:text-3xl">
                  Schedule from Google Drive in minutes
                </h3>
