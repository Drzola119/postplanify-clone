...
export const metadata: Metadata = {
  title: "ChatGPT Integration — Schedule Social Posts with ChatGPT (MCP)",
  description:
    "Connect PostPlanify to ChatGPT via MCP. Create, schedule, and analyze social media posts from ChatGPT using your API key.",
...
const GETTING_STARTED_STEPS = [
  ...
  "Click Create app and paste the server URL: https://api.postplanify.com/api/mcp?api_key=YOUR_API_KEY",
  "Set Authentication to \"No Auth\" and save.",
  "Ask ChatGPT to draft, schedule, or analyze your posts.",
];
          ...
          <Container className="py-8 sm:py-10">
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-7">
                ...
                <div>
                  <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">ChatGPT</h1>
                  <p className="mt-2 text-lg text-blue-100">
                    Manage and schedule your social media from ChatGPT.
                  </p>
          ...
          <div className="grid gap-10 lg:grid-cols-[200px_minmax(0,1fr)]">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">
                ChatGPT integration for PostPlanify
              </h2>
              <p className="mt-4 leading-relaxed text-gray-600">
                Connect PostPlanify to ChatGPT through MCP and run your social media from a chat. Ask ChatGPT to write captions, schedule posts, check analytics, or reply to comments — and it acts on your PostPlanify account.
              </p>
              ...
              <p className="mt-2 leading-relaxed text-gray-600">
                You&apos;ll need a PostPlanify subscription and an API key. ChatGPT connects through its developer-mode connector.
              </p>
            ...
            <div className="flex flex-col gap-10 p-6 sm:p-8 lg:flex-row lg:items-center lg:gap-8 lg:p-10">
              <div className="flex-1 lg:max-w-[44%]">
                ...
                <h3 className="text-2xl font-bold leading-tight tracking-tight text-white sm:text-3xl">
                  Schedule from ChatGPT in minutes
                </h3>
