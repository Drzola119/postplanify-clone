    ...
    <section className="relative overflow-hidden pt-16 pb-0">
      <Container>
        <div className="relative z-10 text-center">
          {/* H2: 48/700/48/normal */}
          <h2 className="text-[48px] font-bold leading-[48px] tracking-normal mb-4">
            All Socials. One Place.
          </h2>
          <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto mb-8">
            Schedule, analyze, and collaborate across all your social accounts.
          </p>

          {/* Social icons row */}
          <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-2 mb-8">
            {SOCIAL_ICONS.map((icon) => (
              <div key={icon.name} className={`transition-all duration-200 hover:scale-110 ${icon.color}`}>
          ...
          <CTAButton
            ...
            size="xl"
            showArrow
            className="min-w-[240px] h-14 px-8 shadow-lg"
          >
            Get Started for Free
          </CTAButton>
        </div>

        {/* Decorative wordmark or logo at bottom */}
        <div className="mt-16 text-center opacity-30 select-none pointer-events-none">
          <p className="text-6xl md:text-8xl font-bold tracking-tight">PostPlanify</p>
        </div>
      </Container>
    </section>
  );
